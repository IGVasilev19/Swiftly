...
public class RegisterMapper {
    ...
    {
        User user = new User(registerRequest.email(), registerRequest.password(), registerRequest.roles());
        Profile profile = new Profile(registerRequest.name(), registerRequest.phoneNumber());
