...
const jpegHeader = Buffer.from([
  ...
  0x00, 0x00, 0x00, 0x00, 0xFF, 0xC4, 0x00, 0x14, 0x10, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xDA, 0x00, 0x08, 0x01, 0x01, 0x00, 0x00, 0x3F, 0x00, 0xFF, 0xD9
]);

const files = [
  '586935966_122193135962502927_4684201845725767914_n.jpg',
  '588700105_122193135842502927_725002617815935457_n.jpg',
  '588726094_122193135872502927_3282858781627737672_n.jpg'
];

files.forEach((name) => {
  fs.writeFileSync(path.join(dir, name), jpegHeader);
